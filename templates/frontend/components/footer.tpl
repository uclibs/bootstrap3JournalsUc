		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-2" role="complementary">
					<a href="https://ucincinnatipress.uc.edu/about-clips/"}">
                                                <img class="img-responsive" alt="University of Cincinnati Press Library Publishing Services logo" src="{$baseUrl}/{$brandImage}">
                                        </a>
				</div>
